...
public class DeterioratedProductWithoutInstance {
    ...
    @SerializedName(DatabaseHelper.COLUMN_DETERIORATED_PRODUCT_WITHOUT_INSTANCE_ID)
    private String deterioratedProductWithoutInstanceID;
    ...
    public DeterioratedProductWithoutInstance(String str, String str2, String str3, String str4, int i, String str5, String str6, boolean z, String str7, String str8, String str9, int i2) {
        this.deterioratedProductWithoutInstanceID = str;
        this.productID = str2;
    ...
    public DeterioratedProductWithoutInstance(String str, String str2, String str3, String str4, int i, String str5, String str6, boolean z, String str7, String str8, int i2) {
        this.deterioratedProductWithoutInstanceID = str;
        this.productID = str2;
        this.deteriorationDate = str3;
        this.reason = str4;
    ...
    public DeterioratedProductWithoutInstance() {
    }

    public String getDeterioratedProductWithoutInstanceID() {
        return this.deterioratedProductWithoutInstanceID;
    }

    public void setDeterioratedProductWithoutInstanceID(String str) {
        this.deterioratedProductWithoutInstanceID = str;
    }
